...
<body>
            ...
            <section class="content-section">
                ...
                <div class="recent-list">
                    ...
                    <div class="recent-item">
                        ...
                        <img src="https://upload.wikimedia.org/wikipedia/vi/0/0b/JustinBieberLoveYourself.png" alt="Song Art">
                        <div class="song-info">
                            <h3>Love Yourself</h3>
                            <p>Justin Bieber</p>
                        </div>
        ...
        <aside class="rightbar">
            ...
            <section class="content-section">
                ...
                <div class="artist-grid">
                    ...
                    <div class="artist-item"><img src="https://vcdn1-giaitri.vnecdn.net/2024/03/12/Ariana-Grande-1-7004-1710212312.jpg?w=460&h=0&q=100&dpr=2&fit=crop&s=CezkhwPhmwck64_0MtUt_A" alt="Artist"><p>Ariana Grande</p></div>
    ...
    <footer class="player">
        ...
        <div class="player-right">
            <button class="player-icon-btn"><i class="fas fa-align-left"></i></button>
            <button class="player-icon-btn"><i class="fas fa-list-ul"></i></button>
            <button class="player-icon-btn"><i class="fas fa-desktop"></i></button>
